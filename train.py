...
def main():
    ...
    if args.sweep_models and device.type == "cuda":
        ...
        sweep_configs = [
            ...
            (128, 2, ""), (128, 3, ""), (128, 4, ""), (128, 5, ""), (128, 6, ""), (128, 8, ""),
            # ------------------------------------------------------------------
            # Mid regime
            # ------------------------------------------------------------------
            (144, 2, ""), (144, 3, ""), (144, 4, ""), (144, 5, ""), (144, 6, ""), (144, 8, ""),
            (160, 3, ""), (160, 4, ""), (160, 6, ""), (160, 8, ""),
            (176, 2, ""), (176, 3, ""), (176, 4, ""), (176, 6, ""), (176, 8, ""),
            (192, 2, ""), (192, 3, ""), (192, 4, ""), (192, 5, ""), (192, 6, ""), (192, 8, ""),
            # ------------------------------------------------------------------
            # Strong mid-large regime
            # ------------------------------------------------------------------
            (224, 4, ""), (224, 6, ""), (224, 8, ""),
            (256, 2, ""), (256, 3, ""), (256, 4, ""), (256, 5, ""), (256, 6, ""), (256, 8, ""),
            # ------------------------------------------------------------------
            # Large regime
            # ------------------------------------------------------------------
            (320, 4, ""), (320, 6, ""), (320, 8, ""), (320, 12, ""),
            (384, 4, ""), (384, 6, ""), (384, 8, ""), (384, 12, ""),
            # ------------------------------------------------------------------
            # Very large regime
            # ------------------------------------------------------------------
            (448, 6, ""), (448, 8, ""), (448, 12, ""),
            (512, 6, ""), (512, 8, ""), (512, 10, ""), (512, 12, ""),
            # ------------------------------------------------------------------
            # Stress tail — fine-grained to find actual VRAM ceiling
            # ------------------------------------------------------------------
            (640, 8, ""),  (640, 10, ""), (640, 12, ""), (640, 14, ""), (640, 16, ""),
            (704, 8, ""),  (704, 10, ""), (704, 12, ""), (704, 14, ""),
            (768, 8, ""),  (768, 10, ""), (768, 12, ""), (768, 14, ""), (768, 16, ""),
            (832, 8, ""),  (832, 10, ""), (832, 12, ""),
            (896, 8, ""),  (896, 10, ""), (896, 12, ""), (896, 14, ""),
            (960, 8, ""),  (960, 10, ""), (960, 12, ""),
            (1024, 6, ""), (1024, 8, ""), (1024, 10, ""), (1024, 12, ""),
            (1088, 6, ""), (1088, 8, ""), (1088, 10, ""),
            (1152, 6, ""), (1152, 8, ""), (1152, 10, ""),
            (1216, 6, ""), (1216, 8, ""),
            (1280, 6, ""), (1280, 8, ""), (1280, 10, ""),
            (1344, 6, ""), (1344, 8, ""),
            (1408, 6, ""), (1408, 8, ""),
            (1472, 6, ""), (1472, 8, ""),
            (1536, 6, ""), (1536, 8, ""),
        ...
        for d_model, n_layers, label in sweep_configs:
            ...
            try:
                ...
                param_s = sm.param_count_str()
                cfg_str = f"d={d_model} L={n_layers} ({param_s})"
                ...
                if used_pct > 100:
                    console.print(f"  {cfg_str:<24} {param_s:<8} "
                                   f"{peak_mb:>8.0f} {used_pct:>5.1f}%  [red]OVER VRAM LIMIT — stopping[/red]")
                ...
                torch.cuda.empty_cache()
                cfg_str = f"d={d_model} L={n_layers}"
